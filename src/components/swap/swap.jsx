...
class Swap extends Component {
    ...
    createWallet = async () => {
        let result = await axios.post('http://157.230.183.255:4000/bridge/createWallet', {
    ...
    verifyTransaction = async () => {
        let result = await axios.post('http://157.230.183.255:4000/bridge/verifyTransaction', {
            address: this.state.bnbReceiveAddress
        })
        if (result) {
    ...
    transferToken = async () => {
        console.log("HI")
        let result = await axios.post('http://157.230.183.255:4000/bridge/transfer', {
            address: this.state.bnbReceiveAddress,
